...
namespace Dacodelaac.EditorUtils
{
    public static class SceneMenu
    {
        ...
        static void ChangeScene(string name)
        {
            ...
            EditorSceneManager.OpenScene(Application.dataPath + "/Dev/Scenes/" + name + ".unity");
        }
        ...
        {
            return File.Exists(Application.dataPath + "/Dev/Scenes/" + name + ".unity");
        }
        ...
        [MenuItem("Scenes/Home Scene", false, 33)]
        static void OpenFarmScene()
        {
            ChangeScene(HomeScene);
        }

        [MenuItem("Scenes/Home Scene", true, 33)]
